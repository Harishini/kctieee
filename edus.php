    ...
    <body>
                    ...
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="">Education Society</a></li>
        ...
        <section id="section">
            <div class="cs_content">
                ...
                <div class="about">
                    <img src="images/society_logo/ES logo.png" class="logo">
                    <br>
                    <h2>ABOUT</h2>
                    <br>
                    <p>The IEEE Education Society is an international organization that promotes, advances, and disseminates state-of-the-art 
                        scientific information and resources related to the Society’s field of interest and provides professional development 
                        opportunities for academic and industry professionals. The Society supports local educators through in-person workshops 
                        hosted by its worldwide chapters. It keeps its members current through well-regarded publications and international 
                        conference events. It provides online continuing education in the form of topical webcasts and MOOCs. 
                        Finally, its world-renowned team of distinguished lecturers speaks about the globally diverse facets of engineering 
                        education through electronic and face-to-face presentations.
                    </p>
                </div>
                <hr>
                ...
                <div class="gallery">
                    <img src="images/students/education/officers/Karthikeyan R.jpg">
                    <div class="desc">Karthikeyan R <br>
                    Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/education/officers/Nandhakishore T.jpg">
                    <div class="desc">Nandhakishore T<br>
                    Vice Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/education/officers/Kanagagiri D.jpg">
                    <div class="desc">Kanagagiri D <br>
                    Secretary</div>
                </div>
                <div class="gallery">
                <img src="images/students/education/officers/Rathish R.jpg">
                    <div class="desc">Rathish R <br>
                    Treasurer</div>
                </div>
                <div class="gallery">
                <img src="images/students/education/officers/Kishore Prasath N S.jpg">
                    <div class="desc">Kishore Prasath N S<br>
                    Events Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/education/officers/Sakthivel D.jpg">
                    <div class="desc">Sakthivel D<br>
                    Media Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/education/officers/Jayashree A.jpg">
                    <div class="desc">Jayashree A <br>
