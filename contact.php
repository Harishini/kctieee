            ...
            <div class="container-fluid"> 
                ...
                <div id="icons-align" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="" class="nav-link"><svg class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg></a></li>
...
<section id="section">
        <div class="contact">
            <h4>IEEE KCT SB</h4>
            <P>Dr. Sasikala S<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> sasikala.s.ece@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9443525425</p><br>

            <h4>IEEE COMPUTER SOCIETY</h4>
            <P>Dr. Bharathi Priya C<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> bharathipriya.c.cse@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9000529497</p><br>

            <h4>IEEE WOMEN IN ENGINEERING</h4>
            <P>Dr. Alagumeenaakshi M<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> alagumeenaakshi.m.ece@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9443368484</p><br>

            <h4>IEEE SIGNAL PROCESSING SOCIETY</h4>
            <P>Dr. Amsaveni A<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> amsaveni.a.ece@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9894036677</p><br>
            ...
            <h4>IEEE EDUCATION SOCIETY</h4>
            <P>Dr. Sasikala S<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> sasikala.s.ece@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9443525425</p><br>

            <h4>IEEE POWER AND ENERGY SOCIETY</h4>
            <P>Dr. Sasikala S<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> sasikala.s.ece@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9443525425</p><br>

            <h4>IEEE CONTROL SYSTEM SOCIETY</h4>
            <P>Dr. Sasikala S<br>
            <i class="fa fa-envelope" aria-hidden="true"></i> sasikala.s.ece@kct.ac.in<br>
            <i class="fa fa-phone" aria-hidden="true"></i> 9443525425</p><br>
        </div>
