...
<html>
    <head>
        ...
        <title>Power Electronics Society</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="">Power and Energy Society</a></li>
        ...
        <section id="section">
            <div class="pels-content">
                <br>
                <h1>POWER AND ENERGY SOCIETY</h1>
                <br>

                <div class="about">
                    <img src="images/society_logo/PELS logo.png" class="logo">
                    <br>
                    <h2>ABOUT</h2>
                    <br>
                ...
                <div class="gallery">
                    <img src="images/students/power_energy/officers/Janardhanan_V.jpg">
                    <div class="desc">Janardhanan V <br>
                    Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/power_energy/officers/Roja.jpg">
                    <div class="desc">Roja<br>
                    Vice Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/power_energy/officers/Gowthham E L P.jpg">
                    <div class="desc">Gowthham E L P <br>
                    Secretary</div>
                </div>
                <div class="gallery">
                <img src="images/students/power_energy/officers/Navaneethakrishnan S M.jpg">
                    <div class="desc">Navaneethakrishnan S M <br>
                    Treasurer</div>
                </div>
                <div class="gallery">
                <img src="images/students/power_energy/officers/Kamali G P.jpg">
                    <div class="desc">Kamali G P <br>
                    Events Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/power_energy/officers/Poornima C.jpg">
                    <div class="desc">Poornima C <br>
                    Media Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/power_energy/officers/Nivethitha G V.jpg">
                    <div class="desc">Nivethitha G V <br>
