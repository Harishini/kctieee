...
<html>
    <head>
        ...
        <title>Signal Processing Society</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="">Signal Processing Society</a></li>
        ...
        <section id="section">
            <div class="sps-content">
                <br>
                <h1>SIGNAL PROCESSING SOCIETY</h1>
                <br>

                <div class="about">
                    <img src="images/society_logo/SPS logo.png" class="logo">
                    <br>
                    <h2>ABOUT</h2>
                    <br>
                    <p>Signal processing is the enabling technology for the generation, transformation, extraction, and interpretation of information. 
                        It comprises the theory, algorithms with associated architectures and implementations, and applications related to processing information contained in 
                        many different formats broadly designated as signals. Signal processing uses mathematical, statistical, computational, heuristic, and/or 
                        linguistic representations, formalisms, modeling techniques and algorithms for generating, transforming, transmitting, and learning from signals. 
                        The Society sponsors various conferences, including the International Conference on Acoustics, Speech, and Signal Processing.
                    </p>
                </div>
                <hr>
                ...
                <div class="gallery">
                    <img src="images/students/signal_processing/officers/Arjun G.jpg">
                    <div class="desc">Arjun G<br>
                    Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/signal_processing/officers/Akash S.jpg">
                    <div class="desc">Akash S<br>
                    Vice Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/signal_processing/officers/Swetha P.jpg">
                    <div class="desc">Swetha P <br>
                    Secretary</div>
                </div>
                <div class="gallery">
                <img src="images/students/signal_processing/officers/Kishore S.jpg">
                    <div class="desc">Kishore S<br>
                    Treasurer</div>
                </div>
                <div class="gallery">
                <img src="images/students/signal_processing/officers/Kavinkumar S P.jpg">
                    <div class="desc">Kavinkumar S P<br>
                    Events Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/signal_processing/officers/Bharaneetharan S.jpg">
                    <div class="desc">Bharaneetharan S<br>
                    Media Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/signal_processing/officers/Jayadharshine S.jpg">
                    <div class="desc">Jayadharshine S<br>
