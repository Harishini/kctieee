...
<html>
    <head>
        ...
        <title>Control System Society</title>
    ...
    <body>
            ...
            <div class="container-fluid"> 
                    ...
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="">Control System Society</a></li>
                ...
                <div id="icons-align" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="" class="nav-link"><button><strong>JOIN IEEE</strong></button></a></li>
                    </ul>
                </div>
            </div>
        </Nav>
        <section id="section">
            <div class="cs_content">
                <br>
                <h1>CONTROL SYSTEM SOCIETY</h1>
                <br>

                <div class="about">
                    <img src="images/society_logo/CSS logo.png" class="logo">
                    <br>
                    <h2>ABOUT</h2>
                    <br>
                    <p>The Control Systems Society is dedicated to the advancement of the theory and practice of systems and control. 
                        The IEEE CSS has been at the forefront of control systems theory and technology. 
                        Its focus is to promote scientific, technological, and educational advancements in the fields of automatic control, decision making, 
                        theory and applications, all over the world. Application areas include, and not limited to, aerospace systems, automotive systems, 
                        communication networks, cyber-physical systems, manufacturing, micro/nano systems, power grids, 
                        process control, robotics, smart communities, and systems and synthetic biology.
                    </p>
                </div>
                <hr>
                ...
                <div class="gallery">
                    <img src="images/students/control_system/officers/Sneha S.jpg">
                    <div class="desc">Sneha S <br>
                    Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/control_system/officers/Samritha S.jpg">
                    <div class="desc">Samritha S<br>
                    Vice Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/control_system/officers/Dakshin D S.jpeg">
                    <div class="desc">/Dakshin D S <br>
                    Secretary</div>
                </div>
                <div class="gallery">
                <img src="images/students/control_system/officers/Aakash S.jpg">
                    <div class="desc">Aakash S <br>
                    Treasurer</div>
                </div>
                <div class="gallery">
                <img src="images/students/control_system/officers/.jpeg">
                    <div class="desc"><br>
                    Events Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/control_system/officers/Thirumalaivasan K N.jpg">
                    <div class="desc">Thirumalaivasan K N <br>
                    Media Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/control_system/officers/Niranjana Ratsha S.jpg">
                    <div class="desc">Niranjana Ratsha S <br>
