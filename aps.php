...
<html>
    <head>
        ...
        <title>Antenna and Propagation Society</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="">Antenna and Propagation Society</a></li>
        ...
        <section id="section">
            <div class="pels-content">
                <br>
                <h1>ANTENNA AND PROPAGATION SOCIETY</h1>
                <br>

                <div class="about">
                    <img src="images/society_logo/APS logo.png" class="logo">
                    <br>
                    <h2>ABOUT</h2>
                    <br>
                    <p>The Power & Energy Society (PES) provides the world's largest forum for sharing the latest in technological developments in the 
                        electric power industry, for developing standards that guide the development and construction of equipment and systems, 
                        and for educating members of the industry and the general public. Members of the Power & Energy Society are leaders in this field, 
                        and they — and their employers — derive substantial benefits from involvement with this unique and outstanding association.
                    </p>
                </div>
                <hr>
                ...
                <div class="gallery">
                    <img src="images/students/antenna_propagation/officers/JAparna V.jpg">
                    <div class="desc">Aparna V <br>
                    Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/antenna_propagation/officers/Navipreethi S.jpg">
                    <div class="desc">Navipreethi S<br>
                    Vice Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/antenna_propagation/officers/Dheepauk N.jpg">
                    <div class="desc">Dheepauk N<br>
                    Secretary</div>
                </div>
                <div class="gallery">
                <img src="images/students/antenna_propagation/officers/Saravanan M.jpg">
                    <div class="desc">Saravanan M<br>
                    Treasurer</div>
                </div>
                <div class="gallery">
                <img src="images/students/antenna_propagation/officers/Nandhini R N.jpg">
                    <div class="desc">Nandhini R N <br>
                    Events Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/antenna_propagation/officers/Nyruthi A K.jpg">
                    <div class="desc">Nyruthi A K<br>
                    Technical Associate</div>
                </div>
                <div class="gallery">
                <img src="images/students/antenna_propagation/officers/Abharnaa M R.jpg">
                    <div class="desc">Abharnaa M R<br>
