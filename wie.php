...
<html>
    <head>
        ...
        <title>Women in Engineering Society</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav" >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="">Women in Engineering Society</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
        ...
        <section id="section">
            <div class="wie-content">
                <br>
                <h1>WOMEN IN ENGINEERING SOCIETY</h1>
                <br>

                <div class="about">
                    <img src="images/society_logo/WIE logo.png" class="logo" style="width: 25%;">
                    <br>
                    <h2>ABOUT</h2>
                    <br>
                    <p>IEEE Women in Engineering (WIE) is one of the largest international professional organizations dedicated to promoting women engineers and scientists, 
                       and inspiring girls around the world to follow their academic interests in a career in engineering. The mission of IEEE WIE is to facilitate the 
                       recruitment and retention of women in technical disciplines globally.IEEE WIE envisions a vibrant community of IEEE women and men collectively using their diverse 
                ...
                <div class="gallery">
                    <img src="images/students/wie/officers/Pavithra S M.jpg">
                    <div class="desc">Pavithira S M <br>
                    Chair</div>
                </div>
                <div class="gallery">
                <img src="images/students/wie/officers/.jpg">
                    <div class="desc"><br>
                    Vice Chair</div>
                </div>
                <div class="gallery">
                ...
                <div class="gallery">
                <img src="images/students/wie/officers/Nalini priya D.jpg">
                    <div class="desc">Nalinipriya D<br>
                    Treasurer</div>
                </div>
                <div class="gallery">
                <img src="images/students/wie/officers/Jana Priya S.jpg">
                    <div class="desc">Jana Priya S<br>
                    Events Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/wie/officers/Gayatri R.jpg">
                    <div class="desc">Gayatri R<br>
                    Media Lead</div>
                </div>
                <div class="gallery">
                <img src="images/students/wie/officers/Manjula R.jpg">
                    <div class="desc">Manjula R <br>
